...
<body data-plugin-page-transition="">
    <div class="body">
                                        ...
                                        <ul class="nav nav-pills">
                                            <li class="nav-item nav-item-borders py-2 d-none d-sm-inline-flex "> <a
                                                    href="https://pu.go.id/" class="text-white"><img
                                                        src="./assets/logo-pu.png" alt="Indonesia" width="25"> PUPR</a>
                                            </li>
                                        ...
                                        <nav class="collapse">
                                            <ul class="nav nav-pills" id="mainNav">
                                                <li class="dropdown dropdown-reverse">
                                                    <a href="home.html" class="dropdown-item"><i
                                                ...
                                                <li class="dropdown"><a href="https://sda.pu.go.id/#"
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li><a href="https://sda.pu.go.id/profil/struktur_organisasi"
                                                                class="dropdown-item">SIH3 WS Mahakam</a></li>
                                                        <li><a href="https://sda.pu.go.id/profil/struktur_organisasi"
                                                        ...
                                                        <li class="dropdown-submenu"><a href="https://sda.pu.go.id/#"
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a href="https://sda.pu.go.id/produk/kategori/national_urban_flood_resilience_project"
                                                                        class="dropdown-item">Sebaran Perijinan SDA</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class="dropdown-submenu"><a href="https://sda.pu.go.id/#"
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a href="https://sda.pu.go.id/produk/kategori/rencana_pola_pengelolaan_sda"
                                                                        class="dropdown-item">Laporan Kekeringan</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class="dropdown-submenu"><a href="https://sda.pu.go.id/#"
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a href="https://sda.pu.go.id/produk/kategori/kamus"
                                                                        class="dropdown-item">Publikasi Hidrologi</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class="dropdown-submenu"><a href="https://sda.pu.go.id/#"
                                ...
                                <!-- <div class="header-nav-features header-nav-features-no-border header-nav-features-lg-show-border order-1 order-lg-2">
                                    <div class="header-nav-feature header-nav-features-search d-inline-flex">
                                        ...
                                        <div class="header-nav-features-dropdown" id="headerTopSearchDropdown">
                                            <form role="search" action="https://sda.pu.go.id/pencarian" method="get">
                                                <div class="simple-search input-group">
                                                    <input class="form-control text-1" id="headerSearch" name="keywords"
                ...
                <div class="container py-3">
                    <div class="row">
                        <div class="col-12 col-lg-12 appear-animation animated fadeInLeftShorter appear-animation-visible"
                            ...
                            <div class="card">
                                <div class="card-side bg-color-primary text-3 text-uppercase "> Struktur Organisasi </div>
                                <br>
                                <div class="container-fluid">
                                    
                                        <a href="./assets/struktur_organisasi_2020.png"
                                    rel="prettyPhoto"> <img
                                    src="./assets/struktur_organisasi_2020.png" height="auto">
                            </a>
                                        ...
                                        <div class="col-12 col-lg-12">
                                            ...
                                            <div class="toggle toggle-primary toggle-lg" data-plugin-toggle="">
                                                ...
                                                <section class="toggle"> <a
                                                        ...
                                                        style="animation-delay: 200ms;">Kepala Seksi Keterpaduan Pembangunan dan Informasi Sumberdaya Air</a>
                                                    <div class="toggle-content">
                                                ...
                                                <section class="toggle"> <a class="toggle-title appear-animation"
                                                        data-appear-animation="maskUp" data-appear-animation-delay="500">Kepala Satuan Kerja Balai Wilayah Sungai</a>
                                                    <div class="toggle-content">
                                                        <p> <b>Tugas</b> <br>Melaksanakan pembinaan pelaksanaan norma, standar, prosedur,
                                                            dan kriteria, serta perencanaan, persiapan, dan pelaksanaan operasi dan
                                                ...
                                                <section class="toggle"> <a class="toggle-title appear-animation"
                                                        data-appear-animation="maskUp" data-appear-animation-delay="600">Kepala Satuan Kerja SNVT PJSA</a>
                                                    <div class="toggle-content">
                                                        <p> <b>Tugas</b> <br>Melaksanakan pembinaan pelaksanaan norma, standar, prosedur,
                                                ...
                                                <section class="toggle"> <a class="toggle-title appear-animation"
                                                        data-appear-animation="maskUp" data-appear-animation-delay="700">Kepala Satuan Kerja SNVT PJPA</a>
                                                    <div class="toggle-content">
                                                ...
                                                <section class="toggle"> <a class="toggle-title appear-animation"
                                                        data-appear-animation="maskUp" data-appear-animation-delay="800">Kepala Satuan Kerja SNVT Pembangunan Bendungan.</a>
                                                    <div class="toggle-content">
                                                ...
                                                <section class="toggle"> <a class="toggle-title appear-animation"
                                                    data-appear-animation="maskUp" data-appear-animation-delay="800">Kepala Satuan Kerja Operasi dan Pemeliharaan Sumber Daya Air</a>
                                                <div class="toggle-content">
                                                    <p> <b>Tugas</b> <br>Melaksanakan penyusunan, kebijakan teknis kerangka kerja,
                                                        pembinaan, pengendalian, pemantauan, evaluasi dan pelaporan kepatuhan intern dan
                                                        manajemen risiko di Direktorat Jenderal Sumber Daya Air. <br> <br> <b>Fungsi</b>
                ...
                <div class="container">
                    ...
                    <div class="row pt-5 mt-4 mb-0">
                        <div class="col-md-5 mb-4 mb-lg-0">
                            <a href="https://sda.pu.go.id/" class="logo">
                            ...
                            </a> <!-- <p style="color: #fff">Alamat:</p>--> <span style="color: #fff"> Kantor BWS
                                Kalimantan IV Samarinda <br>JL. MT. Haryono No. 36, Kota Samarinda, Kalimantan Timur -
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <ul class="list list-icons list-icons-lg">
                                        <!-- <li class="mb-1">
                                            ...
                                            <p class="m-0 text-white">
                                                Gedung Ditjen Sumber Daya Air <br />JL. Pattimura 20,
                                                Kebayoran Baru, <br />
                                    ...
                                    <div class="col mb-5">
                                        <a href="https://www.instagram.com/pupr_sda/"
                                            style="color: #fff; padding-right: 10px" target="_blank">
                                            <i class="fab fa-2x fa-instagram"></i>&nbsp;</a>

                                        <a href="https://twitter.com/pupr_sda" style="color: #fff; padding-right: 10px"
                                            target="_blank">
                                            <i class="fab fa-2x fa-youtube-square"></i>&nbsp;</a>

                                        <a href="https://www.youtube.com/channel/UCSIbT953e30J_K0fKT8nPgA"
                        ...
                        <div class="col-md-3 mb-4 mb-lg-0">
                            <h5 class="text-4 mb-3">Statistik Kunjungan Website</h5>
                            <table class="table table-sm table-hover mb-0">
                                <tbody>
                                    <tr class="">
                                        <td class="align-items-start text-white">Minggu Ini</td>
                                        <td class="align-items-end"><a class="btn btn-outline-warning btn-xs">100
                                                Kunjungan </a></td>
                                    </tr>
                                    <tr class="">
                                        <td class="align-items-start text-white">Bulan Ini</td>
                                        <td class="align-items-end"><a class="btn btn-outline-warning btn-xs">100
                                                Kunjungan </a></td>
                                    </tr>
                                    <tr class="">
                                        <td class="align-items-start text-white">Tahun Ini</td>
                                        <td class="align-items-end"><a class="btn btn-outline-warning btn-xs">100
                                                Kunjungan </a></td>
                                    </tr>
                                    <tr class="">
                                        <td class="align-items-start text-white">Total Kunjungan</td>
                                        <td class="align-items-end"><a class="btn btn-outline-warning btn-xs">100
                                                Kunjungan </a></td>
                                    </tr>
                                </tbody>
                        ...
                        <div class="row">
                            <div class="col d-flex align-items-center justify-content-center">
                                <p class="text-white text-center">
                                    Hak Cipta ©2021 Direktorat Jenderal Sumber Daya Air
        ...
        <script src="./assets/jquery.appear.min.js.download"></script>
        ...
        <script src="./assets/theme.js.download"></script>
        <!-- Theme Custom -->
        <!-- Theme Initialization Files -->
        <script src="./assets/theme.init.js.download"></script>
    ...
    <a class="scroll-to-top" href="https://sda.pu.go.id/#"><i class="fas fa-chevron-up"></i></a>
</body>
